def place_order(menu):
    ...
    while (True):
        ...
        curr_order = input("What would you like to order?").strip()
        ...
        menu_item_no = input("What is the menu item number? ").strip()
        ...
        update_order(order, menu, menu_items)
        ...
        if (more == 'n' or more == 'N'):
            ...
            prices_list = [price for item in order]
